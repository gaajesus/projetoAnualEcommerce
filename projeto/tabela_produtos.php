    ...
    <center>
        ...
        <div id="mae">
            ...
            <div class="fundolog">
                ...
                <h1>Tabela de Produtos - Venus</h1>
            ...
            <div id="tabelas">
                <div class="container">
                    ...
                    <?php
                    include "conexao.php";
                    $sql = "SELECT * FROM produto WHERE excluido=false ORDER BY cod_prod"; 
                    ...
                    $registros = 3;//registros por pagina
                    ...
                    $sql2 = "SELECT * FROM produto WHERE excluido=false ORDER BY cod_prod LIMIT $registros OFFSET $inicio";
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <?php 
                            $categ = $row['categoria_prod'];
                            //echo $categ ."<br>";
                            $sqlcat = "SELECT nome_categoria FROM categoria WHERE cod_categoria = $categ and excluido=false;";
                            $rescat = pg_query($conecta, $sqlcat);
                            $cat = pg_fetch_array($rescat);
                            echo $cat['nome_categoria']; ?>
                        </div>
                        <div class="col-sm">
                       ...
                       <div class="col-sm">
                            ...
                            $preco = number_format($row['preco_prod'], 2, ',', '.');
                        ...
                        <div class="col-sm">
                            <b> <a class="saiba" href="aeproduto.php?cod=<?php echo $row['cod_prod']; ?>">excluir/alterar</a></b>
                        </div>
                    </div>
                    <?php }
                        }
            ...
            <?php
                    for($i = 1; $i < $qtd_pag + 1; $i++){ 
                                echo "<a href='tabela_produtos.php?pagina=$i'><button class='tabela'>".$i."</button></a> &nbsp;" ; 
                            }
                    ?><br><br><br>
