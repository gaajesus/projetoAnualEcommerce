  ...
  <body>
    <center>
      <div id="mae">
        ...
        <div class="fundolog"><br><br><br><br><br>
          <center>
            <br> <br>
            <br> <br>
            <form name="cadastro_venus" method="post" action="categorias.php">
              <h1>Cadastro - Categoria</h1> <br> 
              <p class="nome">
              <label >Nome Categoria*</label>   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;  <input type="text" id="nome_categoria" placeholder="Nome da categoria" required="required" name="nome_cat" onkeypress="return event.charCode>=65 && event.charCode<=90 || event.charCode>=97 && event.charCode<=122 || event.charCode >= 192 && event.charCode <= 253 || event.charCode == 95 || event.charCode == 32" required/>
              </p>
              <p class="submit">
